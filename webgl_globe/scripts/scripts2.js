    ...
    GTW.Stars = function() {
        ...
        function o() {
            ...
            var t = "ru" == navigator.language || "#ru" == location.hash,
                r = t ? "data/map-ru.json" : "data/map.json",
                o = location.host.match(/cybermap.kaspersky.com/) ? "/geoip" : "data/geoip.json";
...
! function() {
    GTW.Labels = function() {
        ...
        e.prototype.load_label_data = function(e) {
            ...
            r.fillStyle = "#000", r.fillRect(0, 0, n.width, n.height), r.font = "30px Ubuntu", r.fillStyle = "white", r.textBaseline = "top";
            var o = [0, 0],
                i = 35;
            ...
            if (this.labels.length) {
                ...
                _.each(this.labels, function(e) {
                    e.coord[2] = e.iso2 == l.geoip_iso2 ? .015 : .001, n(e.pos, e.coord);
                    var r = 1 * e.font_size;
